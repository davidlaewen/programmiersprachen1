 ...
 * FAE facilitates a list data structure:
 */
...
/**
 * Recursion can be implemented through a variation of the non-terminating "omega" program.
 * The fix-point combinator "Y" is made up of omega with an additional routing of (x x)
